...
export default function CourseInfo() {
  return ( 
    ...
    <S.Container>
      ...
      <S.Tender>
        <S.TenderTitle>Подойдет для вас, если:</S.TenderTitle>
        <S.Offers>
          <S.OffersBox>
            <S.OffersNumber>
              <S.PNum>1</S.PNum>
      ...
      <S.DirectionsTitle>Направления:</S.DirectionsTitle>
      <S.DirectionsLine>
        <S.DirectionsText>
          <S.Li>Йога для новичков</S.Li>
          <S.Li>Классическая йога</S.Li>
          <S.Li>Йогатерапия</S.Li>
        </S.DirectionsText>
        <S.DirectionsText>
          <S.Li>Кундалини-йога</S.Li>
          <S.Li>Хатха-йога</S.Li>
          <S.Li>Аштанга-йога</S.Li>
        </S.DirectionsText>
      </S.DirectionsLine>
      <S.DescribeText>
        Благодаря комплексному воздействию упражнений происходит проработка всех
        групп мышц, тренировка суставов, улучшается циркуляция крови. Кроме того,
        упражнения дарят отличное настроение, заряжают бодростью и помогают
